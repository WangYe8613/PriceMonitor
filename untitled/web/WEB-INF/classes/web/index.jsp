  ...
  <div id="bg">
    ...
    <div id="login_wrap">
      <div id="login"><!-- 登录注册切换动画 -->
        ...
        <span>
                    <form action="loginServlet"  method="post"> <!-- JSP通过form表单给Servlet传值 -->
                        <p class="form"><input type="text" name= "username" id="user" placeholder="username"></p>
                        <%
                            Object msg = request.getAttribute("msg");//判断进入该页面是否以“登录失败后的状态”进入的，若是则输出提示信息
                            if(msg!=null)
                                out.println(msg);
                        %>
                        <p class="form"><input type="password" name= "password" id="passwd" placeholder="password"></p>
                        ...
                        <input type="submit" value="Sign in" class="btn" onclick='signin()' id="btn">
                    </form>
